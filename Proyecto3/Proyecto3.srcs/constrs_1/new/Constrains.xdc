...
set_property PACKAGE_PIN T8 [get_ports {b[7]}]
set_property PACKAGE_PIN U8 [get_ports {b[6]}]
set_property PACKAGE_PIN R16 [get_ports {b[5]}]
set_property PACKAGE_PIN T13 [get_ports {b[4]}]
